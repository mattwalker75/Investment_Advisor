...
async function execTool(name, args = {}) {
  ...
  switch (name) {
    ...
    case "research_report": {
      const r = await require("../engine/research").generateReport(args.symbol, args.asset_type);
      return { saved_to_library: true, id: r.id, symbol: r.symbol, report: r.text };
    }
